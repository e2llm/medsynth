"""Hebrew/Israel locale — assembles all he_IL data into a LocaleConfig."""
...
from ..scripts.hebrew import HEBREW_OCR_PATTERNS
...
LOCALE = LocaleConfig(
    ...
    # OCR
    ocr_patterns=HEBREW_OCR_PATTERNS,
    ...
    # Misc
    generic_location="ישראל",
    gender_labels={"male": "זכר", "female": "נקבה"},
    urgency_values=["דחוף", "רגיל", "לא דחוף"],
)
