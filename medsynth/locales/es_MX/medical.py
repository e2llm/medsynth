"""es_MX medical data: conditions, medications, departments, lab tests, ICD-10."""
...
CONDITIONS = [
    ...
    "derrame cerebral", "insuficiencia cardíaca", "fibrilación auricular",
...
DEPARTMENTS = [
    ...
    "traumatología", "neumología", "urología", "gastroenterología",
