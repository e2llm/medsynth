"""ar_SA medical data: conditions, medications, departments, lab tests, ICD-10."""

CONDITIONS = [
    "السكري النوع الثاني", "ارتفاع ضغط الدم", "مرض الشريان التاجي",
    "الانسداد الرئوي المزمن", "الربو", "الفشل الكلوي المزمن",
    "التهاب المفاصل", "السمنة", "الاكتئاب", "الخرف",
    "هشاشة العظام", "فقر الدم", "السكتة الدماغية", "فشل القلب",
    "الرجفان الأذيني", "فرط شحميات الدم", "النقرس", "مرض الكبد الدهني",
]

MEDICATIONS = [
    "ميتفورمين", "إنسولين", "أسبرين", "أملوديبين", "أتورفاستاتين",
    "أوميبرازول", "راميبريل", "ميتوبرولول", "سيمفاستاتين", "لوسارتان",
    "كلوبيدوجريل", "وارفارين", "باروكستين", "ديكلوفيناك", "إيبوبروفين",
    "جابابنتين", "أليندرونات", "ليفوثيروكسين", "هيدروكلوروثيازيد",
]

DEPARTMENTS = [
    "الباطنية", "أمراض القلب", "الأعصاب", "الجراحة العامة",
    "العظام", "الصدرية", "المسالك البولية", "الجهاز الهضمي",
    "الكلى", "الغدد الصماء", "الأورام", "الشيخوخة",
    "الطوارئ", "العناية المركزة",
]

ICD10_CODES = {
    "السكري النوع الثاني": "E11",
    "ارتفاع ضغط الدم": "I10",
    "مرض الشريان التاجي": "I25",
    "الانسداد الرئوي المزمن": "J44",
    "الربو": "J45",
    "الفشل الكلوي المزمن": "N18",
    "التهاب المفاصل": "M19",
    "السمنة": "E66",
    "الاكتئاب": "F32",
    "الخرف": "F03",
...
LAB_TESTS = [
    ...
    {"name": "هيموجلوبين", "unit": "g/dL", "normal_range": (12.0, 17.5), "abnormal_range": (6.0, 11.9)},
    ...
    {"name": "كوليسترول كلي", "unit": "mg/dL", "normal_range": (0, 200), "abnormal_range": (201, 350)},
